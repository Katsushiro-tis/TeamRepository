...
public class OrderRegistCustomerController {
	...
	public String inputAddress(@Valid @ModelAttribute AddressForm addressForm, BindingResult result,
	...
	public String checkOrder(OrderForm oderform, HttpSession session) {
