...
//	FavoriteRepository favoriteRepository;
	 ...
	 * String showFavoriteList(Model model, FavoriteForm form, UserForm userform) {
	 * 
	 * // 商品IDに該当する商品情報を取得 Item item =
	 * itemRepository.getById(Integer.valueOf(form.getId()));
	 * 
	 * // userIDに該当する商品情報を取得 User user = userRepository.getById(userform.getId());
	 * 
	 * // favorite二セーブ Favorite favorite = new Favorite();
	 * 
	 * favorite.setItem(item); favorite.setUser(user);
	 * 
	 * // favoriteにセットできているのか System.out.println(form.getItem());
	 * 
	 ...
	 * String showFavoriteList2(Model model) { List<Favorite> favoriteitems =
